...
import com.example.sonusync.viewmodel.LibraryViewModel
...
object ViewModelModule {
    ...
    @Provides
    @Singleton
    fun provideLibraryViewModel(musicRepository: MusicRepository): LibraryViewModel{
        return LibraryViewModel(musicRepository)
    }
}